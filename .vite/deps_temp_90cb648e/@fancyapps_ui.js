...
Object.defineProperty(f, "version", { enumerable: true, configurable: true, writable: true, value: "5.0.32" }), Object.defineProperty(f, "defaults", { enumerable: true, configurable: true, writable: true, value: {} });
...
var k = class _k extends g {
  ...
  updateControls() {
    ...
    let d2 = { toggleMax: r2 - h2 < 0.5 * (c2 - h2) ? c2 : h2, toggleCover: r2 - h2 < 0.5 * (l2 - h2) ? l2 : h2, toggleZoom: r2 - h2 < 0.5 * (a2 - h2) ? a2 : h2 }[e2.option("click") || ""] || h2, u2 = e2.canZoomIn(), p2 = e2.canZoomOut(), f2 = n2 === A && !!this.option("touch"), g2 = p2 && f2;
    if (f2 && (t(r2) < t(h2) && !this.panOnlyZoomed && (g2 = true), (t(s2.width, 1) > t(s2.fitWidth, 1) || t(s2.height, 1) > t(s2.fitHeight, 1)) && (g2 = true)), t(s2.width * r2, 1) < t(s2.fitWidth, 1) && (g2 = false), n2 === O && (g2 = false), o(i2, this.cn("isDraggable"), g2), !this.option("zoom"))
      return;
    let m2 = u2 && t(d2) > t(r2), v2 = !m2 && !g2 && p2 && t(d2) < t(r2);
    o(i2, this.cn("canZoomIn"), m2), o(i2, this.cn("canZoomOut"), v2);
  ...
  zoomTo(t2 = 1, { friction: e2 = "auto", originX: i2 = "auto", originY: n2 = "auto", event: s2 } = {}) {
    ...
    this.stop();
    let a2 = 1;
    if (this.panMode === O && (s2 = this.pmme || s2), s2 || "auto" === i2 || "auto" === n2) {
    ...
    e2 = "auto" === e2 ? a2 > 1 ? 0.15 : 0.25 : e2, this.applyChange({ scale: a2, originX: i2, originY: n2, friction: e2 }), s2 && this.panMode === O && this.panWithMouse(s2, e2);
  }
  rotateCCW() {
